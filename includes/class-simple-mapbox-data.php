...
class Simple_Mapbox_Data {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'publish_to_draft', $plugin_admin, 'delete_data_from_mapbox', 10, 1 );
		$this->loader->add_action( 'publish_to_pending', $plugin_admin, 'delete_data_from_mapbox', 10, 1 );
