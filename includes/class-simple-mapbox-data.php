...
class Simple_Mapbox_Data {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'draft_map_data_point', $plugin_admin, 'delete_data_from_mapbox', 10, 1 );
		$this->loader->add_action( 'pending_map_data_point', $plugin_admin, 'delete_data_from_mapbox', 10, 1 );
